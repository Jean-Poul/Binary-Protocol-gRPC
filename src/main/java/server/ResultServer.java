...
public class ResultServer {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        try {
            server.start();
            logger.log(Level.INFO, "RESULT SERVER STARTED ON PORT 8082");

            // This awaitTermination method will help to remain the server, otherwise the server will shut down quickly
